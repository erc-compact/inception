...
class PulsarParParser:
    ...
    def get_argument_parser(self):
        ...
        parser.add_argument('--PMRA', metavar='(mas/yr)', required=False, default=0.0, type=float, help='Proper motion in Right Ascension (with cos(Dec) factor)')
        parser.add_argument('--PMDEC', metavar='(mas/yr)', required=False, default=0.0, type=float, help='Proper motion in Declination')
        parser.add_argument('--DIST', metavar='(kpc)', required=False, default=10.0, type=float, help='Distance to pulsar (default: 10 kpc)')
