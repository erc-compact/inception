...
process pulsarx_parfold {
    ...
    python3 ${params.pipeline_code}/PY_peasoup_pulsarx/pipeline_pulsarx_parfold.py --processing_args=${params.config_params} --out_dir=${params.output_dir}  --injection_number=${injection_number} --ncpus=${task.cpus}
...
process peasoup_setup {
    ...
    python3 ${params.pipeline_code}/PY_peasoup_pulsarx/pipeline_peasoup_setup.py --processing_args=${params.config_params} --out_dir=${params.output_dir}  --injection_number=${injection_number}
...
process peasoup_search {
    ...
    python3 ${params.pipeline_code}/PY_peasoup_pulsarx/pipeline_peasoup_search.py --tag=${segment} --processing_args=${params.config_params} --out_dir=${params.output_dir}  --injection_number=${injection_number}
...
process pulsarx_candfold {
    ...
    python3 ${params.pipeline_code}/PY_peasoup_pulsarx/pipeline_pulsarx_candfold.py --tag=${segment} --processing_args=${params.config_params} --out_dir=${params.output_dir}  --injection_number=${injection_number} --ncpus=${task.cpus}
